    ...
    <section id="home" className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 w-full max-w-7xl px-6 text-center">
        ...
        >
          <a 
            href="#projects" 
            className="group flex items-center gap-2 rounded-xl bg-gradient-to-r from-primary to-primary/90 px-8 py-4 font-semibold text-background shadow-[0_4px_20px_rgba(100,116,139,0.25)] transition-all hover:scale-105 hover:shadow-[0_4px_25px_rgba(100,116,139,0.4)]"
          >
            View Projects
