    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col gap-8 text-center">
          ...
          <a 
            href="#contact"
            className="mt-8 mx-auto w-max inline-block rounded-full bg-gradient-to-r from-primary to-primary/80 px-8 py-4 font-display font-bold text-background shadow-[0_0_20px_rgba(100,116,139,0.3)]"
            onClick={() => setIsMobileMenuOpen(false)}
          >
            Let's Talk
          </a>
